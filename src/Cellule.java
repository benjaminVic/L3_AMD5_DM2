public class Cellule{
	...
	public void printNeighborhood(){
		System.out.println("     / \\ / \\");
		System.out.println("    |"+_Aux.numInThree(this.getNeighborId(Cellule.NORTHEAST))+"|"+_Aux.numInThree(this.getNeighborId(Cellule.NORTHWEST))+"|");
		System.out.println("   / \\ / \\ / \\");
		System.out.println("  |"+_Aux.numInThree(this.getNeighborId(Cellule.WEST))+"|"+_Aux.numInThree(this.getId())+"|"+_Aux.numInThree(this.getNeighborId(Cellule.EAST))+"|");
		System.out.println("   \\ / \\ / \\ /");
		System.out.println("    |"+_Aux.numInThree(this.getNeighborId(Cellule.SOUTHEAST))+"|"+_Aux.numInThree(this.getNeighborId(Cellule.SOUTHWEST))+"|");
		System.out.println("     \\ / \\ /");
	}
}
